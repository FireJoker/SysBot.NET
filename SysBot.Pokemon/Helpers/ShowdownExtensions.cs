...
{
    public class ShowdownExtensions
    {
        // 识别蛋
        public static string eggKeyword = "的蛋";

        // 添加持有物
        public static List<string> heldItemKeywords = new()
        {
            "持有",
            "携带"
        };
        ...
        // 添加异色
        public static Dictionary<string, string> shinyTypes = new()
        {
            { "异色", "\nShiny: Yes" },
            { "闪光", "\nShiny: Yes" },
            { "星闪", "\nShiny: Star" },
        ...
        // 添加个体值
        public static Dictionary<string, string> ivsDict = new()
        {
        ...
        public static Dictionary<string, string> partnerInfo = new()
        {
            { "自ID", "\nOT: AutoOT" },
            { "异国", "\nLanguage: Italian" },
            { "日语", "\nLanguage: Japanese" },
        ...
        public static Dictionary<string, string> formDict = new()
        {
            { "阿罗拉","Alola" },
            { "初始","Original" },
            { "丰缘","Hoenn" },
        ...
        public static Dictionary<string, string> marksDict = new()
        {
        ...
        public static Dictionary<string, string> robbonssDict = new()
        {
